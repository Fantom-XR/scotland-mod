...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed2.add_field(name = ".ban" , value = ".ban [ @User ]", inline=False)
        embed2.add_field(name = ".unban" , value = ".unban [ @User ]", inline=False)
        ...
        embed2.add_field(name = ".announce 2 " , value = ".announce 2 [ #channel ] [ Message ] - Text")
        embed2.add_field(name = ".dm" , value = ".dm [ @User ] [ Message ]", inline=False)
        embed.add_field(name = ".mb" , value="Member Count" , inline=False)
        embed.add_field(name = '.ally' , value="List of all ally requirements & benefits" , inline=False)
