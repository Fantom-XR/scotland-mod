...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed4.add_field(name= "ad" , value = "add a advertisement in advertisement channel", inline=False)
        ...
        embed3.add_field(name = "announce" , value = "announce something in a channel usage: .announce #announcement yo mama", inline=False)
        ...
        embed2.add_field(name = "emojify" , value = "emojifyies text" , inline=False)
